...
- charge_control: {"action": "charge_control", "operation": "set"|"get", "level": int}
- desktop_control: {"action": "desktop_control", "operation": "lock"|"unlock"|"night_light"|"media", "state": "on"|"off"|"toggle", "media_command": "play"|"pause"|"playpause"|"next"|"prev"|"stop"}
...
- "set charging limit to 80%" -> {"action": "charge_control", "operation": "set", "level": 80}
- "check charging limit level" -> {"action": "charge_control", "operation": "get"}
- "lock my laptop screen" -> {"action": "desktop_control", "operation": "lock"}
- "unlock my laptop screen" -> {"action": "desktop_control", "operation": "unlock"}
