...
from nova.browser.helper import ChatGPTHandler, GmailHandler, GitHubHandler, GoogleSearchHandler

@unittest.skipUnless(_PLAYWRIGHT_AVAILABLE, "playwright not installed - skipping browser tests")
class TestBrowserResilience(unittest.TestCase):
    ...
    @patch("nova.browser.helper.smart_fill")
    def test_chatgpt_handler_integration(self, mock_smart_fill):
        ...
        mock_smart_fill.assert_called_once_with(self.page, "#prompt-textarea", "a python script")
